...
namespace IwaBiliDanmakuV3
{
  ...
  public class IwaBiliUrlPrefixHelper3 : UdonSharpBehaviour
  {
    [Header("iwaSync3 URL Input")]
    ...
    [Tooltip("Prefix inserted into an empty iwaSync3 URL field. Change this when moving to another domain.")]
