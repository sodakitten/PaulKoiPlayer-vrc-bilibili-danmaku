Shader "IwaBiliDanmaku/TMP Mirror Readable"
{
  Properties
  {
    ...
    [Toggle]_IWBDMForceMirrorFlip ("iwa Force Mirror Flip Test", Float) = 0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      pixel_t VertShader(vertex_t input)
      {
        ...
        if ((_MirrorFlip != 0 && _VRChatMirrorMode != 0) || _IWBDMForceMirrorFlip > 0.5)
        {
          vert.x = -vert.x;
        }
