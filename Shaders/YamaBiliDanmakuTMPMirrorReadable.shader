Shader "YamaBiliDanmaku/TMP Mirror Readable"
{
  Properties
  {
    ...
    [Toggle]_YBDMForceMirrorFlip ("YBDM Force Mirror Flip Test", Float) = 0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      pixel_t VertShader(vertex_t input)
      {
        ...
        if ((_MirrorFlip != 0 && _VRChatMirrorMode != 0) || _YBDMForceMirrorFlip > 0.5)
        {
          vert.x = -vert.x;
        }
