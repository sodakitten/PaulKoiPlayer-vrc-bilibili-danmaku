...
namespace YamaBiliDanmakuTabletV3
{
  ...
  public class YamaBiliDanmakuTabletModule3 : UdonSharpBehaviour
  {
    [Header("YamaPlayer Data Source")]
    [Tooltip("Drag the playback YamaPlayer Controller here. This reference is only used for URL/time sync; tablet position and size never use it.")]
    ...
    [Header("URL Fill")]
    [SerializeField] private YamaBiliTabletUrlPrefixHelper3 _urlPrefixHelper;
    ...
    [Tooltip("Editor-applied style only. Run PaulKoiPlayer > YamaPlayer Tablet > Apply Selected Tablet Bili Danmaku Visual Style after changing this on an existing module.")]
    ...
    private void Start()
    {
      ...
      SetStatus(Utilities.IsValid(_controller) ? "idle" : "drag Controller");
    }
