Shader "YamaBiliDanmakuTablet/TMP Mirror Readable"
{
  Properties
  {
    ...
    [Toggle]_YBDMTForceMirrorFlip ("YBDM Tablet Force Mirror Flip Test", Float) = 0
  }
  ...
  SubShader
  {
    ...
    Pass
    {
      ...
      pixel_t VertShader(vertex_t input)
      {
        ...
        if ((_MirrorFlip != 0 && _VRChatMirrorMode != 0) || _YBDMTForceMirrorFlip > 0.5)
        {
          vert.x = -vert.x;
        }
